...
I'm spending less and less time tinkering with my setup, but I've got a fair bit of customization into the tools that I use daily.
Tmux lets me jump between project sessions instantly, and neovim is configured so I can navigate within a repo the same way, fuzzy searching by filename or string. The catch is I work across two machines, and I want the setup that makes me fast on one to be available on the other.
This is a description of the setup that I have for managing the chaos of a terminal heavy workflow including managing consistency across multiple machines.
